 ...
 * del mensaje, la prioridad y opcionalmente variables para templates.</p>
 * 
 * @param id identificador único de la notificación
 * @param recipient el destinatario de la notificación
 * @param message el contenido del mensaje (puede contener variables en formato {{key}})
 * @param priority la prioridad de la notificación
 * @param templateVariables mapa de variables para reemplazar en el mensaje (opcional)
 * 
 * @author PinApp Team
 */
